...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 47, 8, 1330);
    },
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 36, 4, 1073);
      set_attributes(div1, div_data_2);
      add_location(div1, file, 29, 2, 913);
      attr_dev(div2, "class", "mdc-dialog__scrim");
      add_location(div2, file, 55, 2, 1526);
      set_attributes(div3, div_data_3);
      add_location(div3, file, 8, 0, 250);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, dirty) {
      ...
      set_attributes(div1, div_data_2 = get_spread_update(div1_levels, [
        ...
        64 && div1_class_value !== (div1_class_value = classMap({
          [
            /*container$class*/
            ctx2[6]
          ]: true,
      ...
      set_attributes(div3, div_data_3 = get_spread_update(div3_levels, [
        (!current || dirty[0] & /*className, autoStackButtons, fullscreen, selection, internalClasses*/
        1084 && div3_class_value !== (div3_class_value = classMap({
          [
            /*className*/
            ctx2[2]
          ]: true,
...
function instance_1($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("actionButtonsReversed" in $$props)
      $$invalidate(12, actionButtonsReversed = $$new_props.actionButtonsReversed);
    if ("aboveFullscreen" in $$props)
      $$invalidate(42, aboveFullscreen = $$new_props.aboveFullscreen);
    if ("aboveFullscreenShown" in $$props)
      $$invalidate(13, aboveFullscreenShown = $$new_props.aboveFullscreenShown);
    ...
    if ("previousAboveFullscreenShown" in $$props)
      $$invalidate(24, previousAboveFullscreenShown = $$new_props.previousAboveFullscreenShown);
  };
