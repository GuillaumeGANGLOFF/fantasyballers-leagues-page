...
import {
  MDCTabFoundation
} from "./chunk-RPPRLHCI.js";
import {
  MDCFadingTabIndicatorFoundation,
  MDCSlidingTabIndicatorFoundation
} from "./chunk-WKQRCKT7.js";
import {
  dist_default
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      17039360 ? get_spread_update(tabindicator_spread_levels, [
        dirty[0] & /*active*/
        262144 && { active: (
          /*active*/
          ctx2[18]
        ...
        dirty[0] & /*$$restProps*/
        16777216 && get_spread_object(prefixFilter(
          /*$$restProps*/
          ctx2[24],
          "tabIndicator$"
        ))
...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span0, file2, 37, 2, 824);
      attr_dev(span1, "class", "mdc-tab__ripple");
      add_location(span1, file2, 64, 2, 1503);
    },
    m: function mount(target, anchor) {
...
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const switch_instance_changes = dirty[0] & /*ripple, addClass, removeClass, addStyle, forwardEvents, use, className, active, stacked, minWidth, internalClasses, internalStyles, style, forceAccessible, href, internalAttrs, $$restProps*/
      33521855 ? get_spread_update(switch_instance_spread_levels, [
        ...
        dirty[0] & /*$$restProps*/
        16777216 && get_spread_object(exclude(
          /*$$restProps*/
          ctx2[24],
          ["content$", "tabIndicator$"]
        ))
...
function instance_12($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("style" in $$props)
      $$invalidate(2, style = $$new_props.style);
    if ("tabId" in $$props)
      $$invalidate(25, tabId = $$new_props.tabId);
    if ("ripple" in $$props)
      $$invalidate(3, ripple = $$new_props.ripple);
    if ("stacked" in $$props)
      $$invalidate(4, stacked = $$new_props.stacked);
    ...
    if ("focusOnActivate" in $$props)
      $$invalidate(37, focusOnActivate = $$new_props.focusOnActivate);
    if ("active" in $$props)
