...
function create_fragment(ctx) {
  ...
  const switch_instance_spread_levels = [
    ...
    },
    {
      class: classMap({
        ...
        "mdc-dialog__button": (
          /*context*/
          ctx[17] === "dialog:action"
        ),
        "mdc-top-app-bar__navigation-icon": (
          /*context*/
          ctx[17] === "top-app-bar:navigation"
        ),
        "mdc-top-app-bar__action-item": (
          /*context*/
          ctx[17] === "top-app-bar:action"
        ),
        "mdc-snackbar__action": (
          /*context*/
          ctx[17] === "snackbar:actions"
        ),
        "mdc-banner__secondary-action": (
          /*context*/
          ctx[17] === "banner" && /*secondary*/
          ctx[8]
        ),
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      const switch_instance_changes = dirty & /*Ripple, ripple, color, $$restProps, addClass, removeClass, addStyle, forwardEvents, use, classMap, className, variant, touch, context, secondary, internalClasses, Object, internalStyles, style, actionProp, defaultProp, secondaryProp, href*/
      6289919 ? get_spread_update(switch_instance_spread_levels, [
        ...
        dirty & /*classMap, className, variant, color, touch, context, secondary, internalClasses*/
        133490 && {
          class: classMap({
            [
              /*className*/
            ...
            "mdc-dialog__button": (
              /*context*/
              ctx2[17] === "dialog:action"
            ),
            "mdc-top-app-bar__navigation-icon": (
              /*context*/
              ctx2[17] === "top-app-bar:navigation"
            ),
            "mdc-top-app-bar__action-item": (
              /*context*/
              ctx2[17] === "top-app-bar:action"
            ),
            "mdc-snackbar__action": (
              /*context*/
              ctx2[17] === "snackbar:actions"
            ),
            "mdc-banner__secondary-action": (
              /*context*/
              ctx2[17] === "banner" && /*secondary*/
              ctx2[8]
            ),
            "mdc-banner__primary-action": (
              /*context*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("previousDisabled" in $$props)
      $$invalidate(26, previousDisabled = $$new_props.previousDisabled);
