...
import {
  MDCTabBarFoundation
} from "./chunk-ENAW262K.js";
import {
  MDCTabScrollerFoundation,
  util_exports
} from "./chunk-FCQFWIKU.js";
import "./chunk-RPPRLHCI.js";
import "./chunk-WKQRCKT7.js";
...
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      1024 ? get_spread_update(tabscroller_spread_levels, [get_spread_object(prefixFilter(
        /*$$restProps*/
        ctx2[10],
        "tabScroller$"
      ))]) : {};
...
function instance_12($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("instance" in $$props)
      $$invalidate(4, instance = $$new_props.instance);
    if ("tabScroller" in $$props)
      $$invalidate(6, tabScroller = $$new_props.tabScroller);
    if ("activeIndex" in $$props)
      $$invalidate(17, activeIndex = $$new_props.activeIndex);
    if ("tabAccessorMap" in $$props)
      $$invalidate(18, tabAccessorMap = $$new_props.tabAccessorMap);
    if ("tabAccessorWeakMap" in $$props)
      $$invalidate(19, tabAccessorWeakMap = $$new_props.tabAccessorWeakMap);
